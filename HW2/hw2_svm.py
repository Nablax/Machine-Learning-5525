...
# get average accuracy for train validation and test
...
if __name__ == "__main__":
    ...
    train_accuracy_list, cv_accuracy_list, test_accuracy_list = [], [], []
    for c in c_list:
        train_accuracy, cv_accuracy, test_accuracy = k_fold_cv(data_label_train, data_label_test, 10, c)
